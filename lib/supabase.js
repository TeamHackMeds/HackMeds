...
export const checkConnection = async () => {
  try {
    ...
    const healthCheck = await fetch('https://Superbase_URL.supabase.co/rest/v1/health', {
      method: 'GET',
      headers: {
    ...
    const response = await fetch('https://Superbase_URL.supabase.co/auth/v1/token?grant_type=password', {
      method: 'POST',
      headers: {
        'apikey': supabaseAnonKey,
        'Content-Type': 'application/json'
